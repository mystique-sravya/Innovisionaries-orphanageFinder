...
//=> '/Users/sindresorhus/dev/foo/node_modules/.bin:/Users/sindreso# npm-run-path [![Build Status](https://travis-ci.org/sindresorhus/npm-run-path.svg?branch=master)](https://travis-ci.org/sindresorhus/npm-run-path)
