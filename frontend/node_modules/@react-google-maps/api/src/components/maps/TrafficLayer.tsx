...
export interface TrafficLayerProps {
  ...
  /** This callback is called when the trafficLayer instance has loaded. It is calimport { memo, PureComponent, useContext, useEffect, useState, type ContextType } from 'react'
