...
export interface AutocompleteProps {
  ...
  /** The types of predictions to be returned. For a list of supported types, see the dimport { Children, type ContextType, createRef, PureComponent, type ReactChild, type RefObject } from 'react'
