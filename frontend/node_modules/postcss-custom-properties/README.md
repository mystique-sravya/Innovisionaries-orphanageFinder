...
```js
postcssCustomProperties({
  importFrom: 'path/to/file.css' // => :roo# PostCSS Custom Properties [<img src="https://postcss.github.io/postcss/logo.svg" alt="PostCSS" width="90" height="90" align="right">][postcss]
