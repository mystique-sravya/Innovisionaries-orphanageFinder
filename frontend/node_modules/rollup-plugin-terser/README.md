...
> ⚠️ **Caveat:** any function used in options object cannot rely on its surrounding scope, since it is executed # rollup-plugin-terser [![Travis Build Status][travis-img]][travis]
