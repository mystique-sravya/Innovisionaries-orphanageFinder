...
export * from "./types";
declare const defaultModifiers: (import("./modifiers/popperOffsets").PopperOffsetsModifier | import("./modifiers/eventListeners").EventListenimport { popperGenerator, detectOverflow } from "./createPopper";
export * from "./types";
