...
- Alphabetical  
`alphabetical`  
*Default, order in a simple alphabetical manner from a <img alt='CSS declaration sorter logo' src='https://raw.githubusercontent.com/Siilwyn/css-declaration-sorter/master/logo.svg?sanitize=true' height='260' align='right'>
