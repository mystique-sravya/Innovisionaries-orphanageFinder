...
declare const globby: {
	...
	@param options - See the [`fast-glob` options](https://github.com/mrmlnc/fast-glob#optioimport {Options as FastGlobOptions, Entry as FastGlobEntry} from 'fast-glob';
