...
- [#4495](https://github.com/rollup/rollup/pull/4495): Update docs for --configPlugin using typescript (@Jimmydale# rollup changelog
...
- [#2985](https://github.com/rollup/rollup/pull/2985): Improve sourcemap types (@jridg# rollup changelog
